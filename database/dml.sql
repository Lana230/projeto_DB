--Ordem de apagar os dados das tabelas
DELETE FROM reg_vacina;
...
--Ordem de inserções nas tabelas
...
('Carla Mendes Ferreira',2749826,'União estável'),
...
('Aline Rocha Pereira',8765432,'União estável'),
...
('Aline Barbosa dos Santos', 7654321, 'União estável'),
('Marcos Vinicius Teixeira Lima', 8765432, 'Casado(a)'),
('Patricia Fernandes Costa', 8765432, 'Solteiro(a)'),
('João Victor Almeida Santos',7453626,'Solteiro(a)'),
('Beatriz Oliveira Mendes',7453626,'Casado(a)'),
('Lucas Henrique Rocha Lima',1234567,'Solteiro(a)'),
('Amanda Cristina Barbosa Alves',2749826,'Solteiro(a)'),
('Pedro Augusto Fernandes Souza',7654321,'Casado(a)'),
('Larissa Beatriz Costa Ribeiro',8765432,'Solteiro(a)');
...
('1001-CE', 'Ginecologista', 37),
('1002-CE', 'Pediatria', 38),
('1003-CE', 'Psiquiatria', 39),
('1004-CE', 'Clinico Geral', 40),

('1005-CE', 'Ginecologista', 41),
('1006-CE', 'Clinico Geral', 42),
('1007-CE', 'Pediatria', 43),
('1008-CE', 'Clinico Geral', 44),

('1009-CE', 'Ginecologista', 45),
('1010-CE', 'Clinico Geral', 46),
('1011-CE', 'Clinico Geral', 47),
('1012-CE', 'Clinico Geral', 48),

('1013-CE', 'Clinico Geral', 49),
('1014-CE', 'Ginecologista', 50),
('1015-CE', 'Clinico Geral', 51),
('1016-CE', 'Clinico Geral', 52),

('1017-CE', 'Ginecologista', 53),
('1018-CE', 'Pediatria', 54),
('1019-CE', 'Clinico Geral', 55),
('1020-CE', 'Clinico Geral', 56);
...
-- Depende de pessoa + endereco
INSERT INTO cidadao(num_sus,data_nascimento,genero,naturalidade,ocupacao,id_endereco,id_pessoa)
VALUES
...
(9000008,'1991-10-02','F','Barbalha','Vendedora',29,8),
...
(9700005,'2018-06-18','M','Barbalha','Estudante',29,35),
...
(9000001, 78.5, 1.72, '2026-03-10', '130/85'),
(9000002, 62.3, 1.60, '2026-03-11', '120/80'),
(9000003, 55.0, 1.58, '2026-03-12', '115/75'),
(9000004, 68.2, 1.65, '2026-03-13', '125/80'),
(9500001, 3.2, 0.50, '2026-03-02', '80/50'),
(9500003, 22.0, 1.10, '2026-03-05', '90/60'),

(9000005, 85.0, 1.75, '2026-03-10', '145/90'),
(9000006, 64.0, 1.62, '2026-03-11', '120/80'),
(9000007, 59.0, 1.60, '2026-03-12', '118/78'),
(9000008, 70.0, 1.68, '2026-03-13', '128/82'),

(9700001, 21.0, 1.08, '2026-03-09', '95/60'),
(9700002, 19.5, 1.02, '2026-03-08', '90/60'),

(9000009, 90.0, 1.78, '2026-03-10', '150/95'),
(9000010, 58.0, 1.59, '2026-03-11', '115/75'),
(9000011, 60.0, 1.63, '2026-03-12', '120/80'),
(9000012, 82.0, 1.74, '2026-03-13', '138/88'),

(9000014, 65.0, 1.64, '2026-03-10', '122/80'),
(9000015, 88.0, 1.80, '2026-03-11', '142/90'),
(9000016, 55.0, 1.60, '2026-03-12', '110/70'),
(9000017, 79.0, 1.70, '2026-03-13', '135/85'),

(9000019, 84.0, 1.76, '2026-03-10', '140/90'),
(9000020, 61.0, 1.62, '2026-03-11', '120/80'),
(9000021, 87.0, 1.79, '2026-03-12', '145/92'),
(9000022, 63.0, 1.64, '2026-03-13', '125/82');




-- Depende de cidadao e grupo
...
('2026-03-23', 1234567, 'consulta', 20, '1004-CE'),
('2026-03-23', 2749826, 'consulta', 18, '1002-CE'),
('2026-03-23', 7654321, 'consulta', 25, '1010-CE'),
('2026-03-23', 8765432, 'consulta', 18, '1019-CE'),
...
-- Depende de medicamento + ubs
INSERT INTO medicamento_ubs (id_medicamento, id_ubs, num_lote, quantidade_disponivel, validade)
VALUES

(1, 1234567, 'L001', 100, '2026-12-31'),
(2, 2749826, 'L002', 200, '2027-05-20'),
(3, 7654321, 'L003', 150, '2026-08-15'),
(4, 8765432, 'L004', 80,  '2025-11-10'),
(5, 7453626, 'L005', 60,  '2026-03-01'),

(1, 2749826, 'L006', 90,  '2026-09-30'),
(2, 7654321, 'L007', 120, '2027-01-01');




-- Depende de vacina + grupo
...
-- Depende de cidadao + vacina + enfermeiro + ubs
INSERT INTO reg_vacina (num_sus, id_vacina, cip, id_ubs, data_vacina) VALUES

(9000001, 14, 'ENF1001', 1234567, '2026-03-10'),
(9000002, 13, 'ENF1002', 1234567, '2026-03-11'),
(9000003, 14, 'ENF1003', 1234567, '2026-03-12'),

(9500001, 1, 'ENF1001', 1234567, '2026-03-02'),
(9500001, 2, 'ENF1002', 1234567, '2026-03-02'),
(9500003, 9, 'ENF1003', 1234567, '2026-03-05'),

(9000005, 13, 'ENF1004', 2749826, '2026-03-10'),
(9000006, 11, 'ENF1005', 2749826, '2026-03-11'),
(9000007, 14, 'ENF1006', 2749826, '2026-03-12'),

(9700001, 6, 'ENF1007', 2749826, '2026-03-09'),
(9700002, 9, 'ENF1007', 2749826, '2026-03-08'),

(9000009, 14, 'ENF1008', 7654321, '2026-03-10'),
(9000010, 13, 'ENF1008', 7654321, '2026-03-11'),

(9000014, 11, 'ENF1005', 8765432, '2026-03-10'),
(9000015, 14, 'ENF1006', 8765432, '2026-03-11'),

(9000019, 13, 'ENF1002', 7453626, '2026-03-10'),
(9000020, 11, 'ENF1003', 7453626, '2026-03-11'),

(9000021, 14, 'ENF1004', 7453626, '2026-03-12'),
(9000022, 9,  'ENF1001', 7453626, '2026-03-13');




-- Depende de cidadao + fila
-- INSERT INTO agendamento ...